...
# List of proxies in format (protocol://IP:port)
...
# Example usage
url_to_fetch = 'https://docs.google.com/forms/d/1LRhvB6P4-Yw8TSyUVk4Ls7L339ahdqUoDhnPD6dusrA/edit?usp=forms_home&ths=true'
for proxy in proxies:
    fetch_url(url_to_fetch, proxy)